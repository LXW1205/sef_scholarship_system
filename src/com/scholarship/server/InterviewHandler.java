...
import com.scholarship.dao.InterviewDAO;
import com.scholarship.dao.EvaluationDAO;
import com.scholarship.dao.ApplicationDAO;
import com.scholarship.dao.NotificationDAO;
...
public class InterviewHandler implements HttpHandler {
                    ...
                    if (app != null) {
                        ...
                        if (student != null) {
                            ...
                            notificationDAO.create(
                                    new com.scholarship.model.Notification(0, student.getId(), msg, null, false));
                        }
                    }
                }

                // Audit log
                com.scholarship.dao.AuditLogDAO.log(null, "Committee", "Interview Scheduled", "Interview",
    ...
    private Evaluation findEvalByEvalId(int evalId) {
        ...
        try {
            ...
            java.sql.Connection conn = com.scholarship.db.DatabaseConnection.getConnection();
