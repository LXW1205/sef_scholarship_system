...
public class EvaluationDAO {
    ...
    public void saveScores(int evalId, java.util.List<scholarship.model.EvaluationScore> scores) {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            try (PreparedStatement insStmt = conn.prepareStatement(insSql)) {
                for (scholarship.model.EvaluationScore s : scores) {
    ...
    public java.util.List<scholarship.model.EvaluationScore> findScoresByEvalId(int evalId) {
        java.util.List<scholarship.model.EvaluationScore> list = new java.util.ArrayList<>();
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    scholarship.model.EvaluationScore s = new scholarship.model.EvaluationScore(
                            rs.getInt("scoreID"),
                            rs.getInt("evalID"),
