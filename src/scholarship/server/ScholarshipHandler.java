...
import scholarship.model.Criterion;
...
public class ScholarshipHandler implements HttpHandler {
    ...
    private void handleDelete(HttpExchange exchange) throws IOException {
        ...
        if (id != -1 && scholarshipDAO.delete(id)) {
            scholarship.dao.AuditLogDAO.log(null, "Admin", "Scholarship Deleted", "Scholarship",
    ...
    private void handlePost(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            if (id > 0) {
                ...
                if (success) {
                    scholarship.dao.AuditLogDAO.log(null, "Admin", "Scholarship Updated", "Scholarship",
                ...
                success = newId > 0;
                if (success) {
                    scholarship.dao.AuditLogDAO.log(null, "Admin", "Scholarship Created", "Scholarship",
    ...
    private String getScholarshipsJson(boolean all, String studentId) {
        ...
        try {
            ...
            if (studentId != null) {
                scholarship.dao.UserDAO userDAO = new scholarship.dao.UserDAO();
                scholarship.model.User user = userDAO.findUserByRoleID(studentId, "Student");
                if (user instanceof scholarship.model.Student) {
                    scholarship.model.Student student = (scholarship.model.Student) user;
    ...
    public static boolean isEligible(scholarship.model.Student student, Scholarship scholarship) {
