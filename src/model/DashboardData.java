...
public class DashboardData {
    ...
    public DashboardData(int totalUsers, int activeScholarships, int pendingApps, int awardedMonth) {
        this(totalUsers, activeScholarships, pendingApps, awardedMonth, new java.util.HashMap<>(),
    ...
    public DashboardData(int totalUsers, int activeScholarships, int pendingApps, int awardedMonth,
        ...
        this(totalUsers, activeScholarships, pendingApps, awardedMonth, trendData, userRoles,
