    ...
    private String getStatsJson(String range) {
        try {
            ...
            return String.format(
                    "{\"totalUsers\": %d, \"activeScholarships\": %d, \"pendingApps\": %d, \"awardedMonth\": %d, \"trends\": %s, \"userRoles\": %s, \"awardDistribution\": %s, \"statusDistribution\": %s}",
                    data.getTotalUsers(), data.getActiveScholarships(), data.getPendingApps(), data.getAwardedMonth(),
