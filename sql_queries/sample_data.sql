-- Insert Users (Directly into subclasses due to INHERITS)
-- Note: userID will be automatically generated by the shared sequence from "User"
...
VALUES ('Dr. Reviewer One', 'Review@123', 'reviewer1@mmu.edu.my', 'Reviewer', TRUE, 'R001', 'Faculty of Engineering');
INSERT INTO Reviewer (fullName, password, email, role, isActive, reviewerID, department) 
VALUES ('Prof. Reviewer Two', 'Review@123', 'reviewer2@mmu.edu.my', 'Reviewer', TRUE, 'R002', 'Faculty of Computing');
INSERT INTO Reviewer (fullName, password, email, role, isActive, reviewerID, department) 
VALUES ('Dr. Reviewer Three', 'Review@123', 'reviewer3@mmu.edu.my', 'Reviewer', TRUE, 'R003', 'Faculty of Management');
...
VALUES ('Ahmad bin Ismail', 'Student@123', 'ahmad.ismail@student.mmu.edu.my', 'Student', TRUE, 'S2024001', 3.85, 'Software Engineering', 'Bachelor', 'Year 2', '2026', 3500.00);

INSERT INTO Student (fullName, password, email, role, isActive, studentID, cgpa, major, qualification, yearOfStudy, expectedGraduation, familyIncome)
VALUES ('Siti binti Rahman', 'Student@123', 'siti.rahman@student.mmu.edu.my', 'Student', TRUE, 'S2024002', 3.92, 'Data Science', 'Bachelor', 'Year 3', '2025', 4200.00);

INSERT INTO Student (fullName, password, email, role, isActive, studentID, cgpa, major, qualification, yearOfStudy, expectedGraduation, familyIncome)
VALUES ('Chong Wei Lun', 'Student@123', 'chong.wei@student.mmu.edu.my', 'Student', TRUE, 'S2024003', 3.67, 'Computer Science', 'Bachelor', 'Year 1', '2027', 8000.00);

INSERT INTO Student (fullName, password, email, role, isActive, studentID, cgpa, major, qualification, yearOfStudy, expectedGraduation, familyIncome)
VALUES ('Kumar a/l Rajendran', 'Student@123', 'kumar.raj@student.mmu.edu.my', 'Student', TRUE, 'S2024004', 3.45, 'Mechanical Engineering', 'Bachelor', 'Year 2', '2026', 2500.00);

INSERT INTO Student (fullName, password, email, role, isActive, studentID, cgpa, major, qualification, yearOfStudy, expectedGraduation, familyIncome)
VALUES ('Nurul Aina', 'Student@123', 'nurul.aina@student.mmu.edu.my', 'Student', TRUE, 'S2024005', 3.78, 'Foundation in IT', 'Foundation', 'Year 1', '2025', 12000.00);
